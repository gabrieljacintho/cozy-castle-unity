...
5) Double click the Universal Renderer asset.
6) Click "+" to add the Shiny SSR Renderer Feature to the list of the Universal Renderer Features.
...
Version 32.1 beta
- [Fix] Fixed near camera attenuation being applied even when Start Distance is 0 (default), which caused reflections to fade on objects close to the camera

Version 32.0
- Added new vignette mode: Edge (Box) which adds a bit more coverage
- Added HDRP Clamp option: useful to clamp highlights on reflections

Version 31.0
- Added support for Unity 6.4

Version 30.0
- Improved raymarching algorithm
- Added occlusion map support
- Added orthographic camera support

Version 25.1
- Skybox reflection: improved support for metallic + smoothness workflow

Version 25.0
- Added "Reflect Skybox" option with two modes: Only Visible Sky or Cubemap

Version 24.3
- Added "Skybox Multiplier" to Reflections script

Version 24.2
- Added "Edge Aware Blur" to reduce bleeding of large blurred reflections

Version 24.1
- Skybox reflections: added HDR and culling mask options

Version 24.0
- Added "Opaque Reflections Blending". Allows blending reflections from transparent objects (using Reflection scripts) with opaque reflections in deferred.
- Improved support for custom metallic & smoothness render textures provided by user

Version 23.2.2
- Reduced black pixels in reflections when downscaling is used
- [Fix] Physical camera lens shift fix

Version 23.1.1
- [Fix] Skybox reflection fixes

Version 23.1
- Added "All Objects In Layer" option to the Include property of the Reflections script
- Added "Far Fade Start Distance" option. Stops reflections beyond certain distance to camera.

Version 23.0
- Added "Transparency Support" option which allows transparent objects to be included in the reflections

Version 22.0
- Added "Reflections Max Distance" option which limits the distance to a reflection script to be considered.
