Shader "Hidden/Kronnect/RadiantGI/DepthOnly"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "Radiant GI DepthOnly Pass"
            HLSLPROGRAM
            #pragma target 4.5
            ...
            #include "RadiantGIDepthOnly_Include.hlsl"
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "Radiant GI DepthOnly Pass"  // for older GPUs with no DOTs instancing
            HLSLPROGRAM
            #pragma target 2.0
            #pragma vertex UnlitPassVertex
            #pragma fragment UnlitPassFragment
